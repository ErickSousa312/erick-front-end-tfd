...
export default function FormPaciente() {
  const [dataPaciente, dispatch] = useReducer(
    reducerPaciente,
      ...
      <section className={styles.section1Container}>
        ...
        <label className={styles['form-label']}>
          ...
          <input
            ...
            onChange={(e) =>
              dispatch({ type: 'setNomePaciente', payload: e.target.value })
            }
          />
        </label>
        ...
        <label className={styles['form-label']}>
          ...
          <input
            ...
            onChange={(e) =>
              dispatch({ type: 'setOrgaoEmissor', payload: e.target.value })
            }
          />
        </label>
        ...
        <label className={styles['form-label']}>
          ...
          <input
            ...
            onChange={(e) =>
              dispatch({ type: 'setNumeroCartaoSUS', payload: e.target.value })
            }
          />
        </label>
      ...
      <section className={styles.section2Container}>
        ...
        <label className={styles['form-label']}>
          ...
          <input
            ...
            onChange={(e) =>
              dispatch({ type: 'setNomeSocial', payload: e.target.value })
            }
          />
        </label>
        <label className={styles['form-label']}>
          ...
          <input
            ...
            onChange={(e) =>
              dispatch({ type: 'setSexo', payload: e.target.value })
            }
          />
        </label>
      </section>
      ...
      <section className={styles.section3Container}>
        ...
        <label className={styles['form-label']}>
          ...
          <input
            ...
            onChange={(e) =>
              dispatch({
                type: 'setAcompanhantesDataNascimento',
                payload: e.target.value,
              })
            }
          />
