...
export default function FormMedProf() {
    const [dataMed, dispatch] = useReducer(reducerMedProf, initialStateFuncionario)
            ...
            <section className={styles.section1Container}>
                <label className={styles['form-label']}>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            dispatch({ type: 'setIdentiProfissional', payload: e.target.value })
                        }
                    />
                </label>
                <label className={styles['form-label']}>
                ...
                <label className={styles['form-label']}>
                    ...
                    <input
                        ...
                        onChange={(e) => dispatch({ type: 'setNumeroRegistro', payload: e.target.value })}
                    />
                </label>
                ...
                <label className={styles['form-label']}>
                    ...
                    <input
                        ...
                        type="text"
                        value={dataMed.UF}
                        onChange={(e) => dispatch({ type: 'setUF', payload: e.target.value })}
                    />
                </label>
            ...
            <section className={styles.section2Container}>
                ...
                <label className={styles['form-label']}>
                    ...
                    <input
                        ...
                        type="text"
                        value={dataMed.Cargo}
                        onChange={(e) => dispatch({ type: 'setCargo', payload: e.target.value })}
                    />
                </label>
                ...
                <label className={styles['form-label']}>
                    ...
                    <input
                        ...
                        onChange={(e) => dispatch({ type: 'setCodigoCBO', payload: e.target.value })}
                    />
                </label>
            </section>
            <section className={styles.section3Container}>
                <label className={styles['form-label']}>
                    ...
                    <input
                        ...
                        onChange={(e) => dispatch({ type: 'addEspecialidade', payload: e.target.value })}
                    />
                </label>
                <label className={styles['form-label']}>
                    Centro de Saúde:
            ...
            <section className={styles.section4Container}>
                <label className={styles['form-label']}>
                    ...
                    <textarea
                        ...
                        onChange={(e) => dispatch({ type: 'setAfastamento', payload: e.target.value })}
                    />
                </label>
            </section>
